...
const IssueBook = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (memberResultsRef.current && !memberResultsRef.current.contains(e.target)) {
        setMemberResults([]);
      }
      if (bookResultsRef.current && !bookResultsRef.current.contains(e.target)) {
        setBookResults([]);
      }
    };
  ...
  const selectMember = (member) => {
    ...
    if (member.payment !== 'paid') {
      setWarningMessage('This member has unpaid fees. Please collect payment before issuing books.');
  ...
  const checkFormValidity = () => {
    if (selectedMember && selectedBook && copySelect && selectedMember.payment === 'paid') {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedMember && selectedBook && copySelect) {
      ...
      setSuccessMessage(`Book "${selectedBook.name}" (${copySelect}) issued successfully to ${selectedMember.name}!`);
    }
  };
            ...
            <div style={{
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{
                  ...
                  />
                  <div ref={memberResultsRef} style={{
                    maxHeight: '200px',
                    overflowY: 'auto',
                    border: '1px solid #e9ecef',
                    borderRadius: '5px',
                  ...
                  <div ref={bookResultsRef} style={{
                    ...
                    {bookResults.map((book) => (
                      <div
                        ...
                        onMouseOut={(e) => (e.target.style.background = '#fff')}
                      >
                        {book.name} by {book.author} ({book.available} available)
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <button
                    ...
                    onMouseOver={(e) => {
                      if (!isIssueButtonDisabled) e.target.style.background = '#555';
                    }}
                    onMouseOut={(e) => {
                      if (!isIssueButtonDisabled) e.target.style.background = '#333';
                    }}
                  >
                    Issue Book
                  </button>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: selectedMember?.status === 'active' ? '#d4edda' : '#f8d7da',
                    color: selectedMember?.status === 'active' ? '#155724' : '#721c24',
                  }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      {selectedMember ? `LIB00${selectedMember.id}` : 'LIB001234'}
                    </span>
                  </div>
                  <div style={{
                    display: 'flex',
                    ...
                    <span style={{
                      ...
                      {selectedMember ? selectedMember.email : 'john.doe@email.com'}
                    </span>
                  </div>
                  <div style={{
                    display: 'flex',
                  ...
                  <div style={{
                    ...
                    <span style={{
                      fontWeight: 500,
                      color: selectedMember?.payment === 'paid' ? '#28a745' : '#dc3545',
                    }}>
                      {selectedMember ? (selectedMember.payment === 'paid' ? 'Paid (Aug 30)' : 'Due') : 'Paid (Aug 30)'}
                    </span>
                  </div>
                  <div style={{
                    display: 'flex',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    fontWeight: 500,
                    textTransform: 'uppercase',
                    background: selectedBook?.available > 0 ? '#d4edda' : '#f8d7da',
                    color: selectedBook?.available > 0 ? '#155724' : '#721c24',
                  }}>
                    {selectedBook ? (selectedBook.available > 0 ? 'Available' : 'Unavailable') : 'Available'}
                  </div>
                </div>
                <div style={{
                  display: 'grid',
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      {selectedBook ? `978-0${selectedBook.id}2350884` : '978-0132350884'}
                    </span>
                  </div>
                  <div style={{
                    display: 'flex',
                  ...
                  <div style={{
                    ...
                    <span style={{
                      fontWeight: 500,
                      color: selectedBook?.available > 0 ? '#28a745' : '#dc3545',
                    }}>
