...
const ReturnBook = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      if (
        window.confirm("Book returned successfully! Process another return?")
      ) {
        resetForm();
      } else {
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: errorMessage ? "5px" : 0,
                  marginBottom: "1rem",
              ...
              <div
                style={{
                  ...
                  color: successMessage ? "#155724" : "transparent",
                  padding: successMessage ? "0.75rem" : 0,
                  borderRadius: successMessage ? "5px" : 0,
                  marginBottom: "1rem",
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: "1.5rem" }} ref={searchResultsRef}>
                  ...
                  <div
                    style={{
                      maxHeight: "200px",
                      overflowY: "auto",
                      border: showResults ? "1px solid #e9ecef" : "none",
                      borderRadius: "5px",
                      background: "#fff",
                      ...
                      filteredBooks.map((issue) => (
                        <div
                          ...
                          style={{
                            padding: "0.75rem",
                            borderBottom:
                              issue === filteredBooks[filteredBooks.length - 1]
                                ? "none"
                                : "1px solid #e9ecef",
                            cursor: "pointer",
                        ...
                        >
                          {issue.book.name} - {issue.member.name} (Copy #
                          {issue.book.copyId})<br />
                          <small>
                ...
                <div
                  style={{
                    ...
                    borderRadius: "8px",
                    marginBottom: "1.5rem",
                    display: selectedIssue ? "block" : "none",
                  }}
                >
                  ...
                  >
                    ...
                    <span
                      style={{
                        color:
                          returnDetails.fineAmount > 0 ? "#dc3545" : "#28a745",
                      }}
                    >
                ...
                >
                  <button
                    ...
                    onMouseOver={(e) =>
                      selectedIssue && (e.target.style.background = "#555")
                    }
                    onMouseOut={(e) =>
                      selectedIssue && (e.target.style.background = "#333")
                    }
                  >
                    Process Return
                  </button>
            ...
            >
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      background:
                        selectedIssue?.status === "ontime"
                          ? "#d4edda"
                          : selectedIssue?.status === "due"
                          ? "#fff3cd"
                          : "#f8d7da",
                      color:
                        selectedIssue?.status === "ontime"
                ...
                >
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    <span style={{ fontWeight: 500, color: "#333" }}>
                      {selectedIssue
                        ? `${selectedIssue.member.name} (LIB${selectedIssue.member.id})`
                        : ""}
                    </span>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              <div
                style={{
                  ...
                  padding: "1.5rem",
                  marginBottom: "1.5rem",
                  display: returnDetails.fineAmount > 0 ? "block" : "none",
                }}
              >
